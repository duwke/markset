...
### a generic class for displaying 10x60 matrix.  Consumed by web and led display.
                    ...
                    if timeline_seconds == self.seconds_countdown_:
                        if timeline_obj.__contains__("function"):
                            ...
                            if self.timeline_function_ == "ShowOrder": 
                                ...
                                self.music_countdown_ = 19
                        if timeline_obj.__contains__("music_timeout") and timeline_obj.__contains__("music"):
    ...
    def count_down_tick(self, reset_background = True):
        ...
        if (self.tick_index_ % self.ticks_per_second_) == 0:
            ...
            if reset_background:
                self.leds_.clear()
            self.leds_.fill_text(str(num_min) + ":" + str(seconds_remaining).zfill(2), 1, 2, 0xFF0000)
