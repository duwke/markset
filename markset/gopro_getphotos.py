...
parser.add_argument('--all', "-a", help='Download all', required=False, type=bool, default=True)
parser.add_argument('--out', "-o", help='Output path', default="/Users/darin/Public")
...
if args.video:
	for media in medialist:
		dat = datetime.fromtimestamp(int(media[3])).date()
